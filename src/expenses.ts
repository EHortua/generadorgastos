/*Una interfaz es una estructura que nos permite definir algunos tipos de dato que después queremos que tenga lo que vamos a crear */
/*Interface es similar a un objeto de datos y type es decir que ese dato puede ser o x o y*/
...
class ArrayList<T>{
    ...
    add(item:T):void{ /*Funciona también sin ponerle void*/
